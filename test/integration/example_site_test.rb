...
class ExampleSiteTest < Minitest::Test
  ...
  def test_llms_txt_exists
    assert File.exist?(File.join(DEST_DIR, "llms.txt")), "llms.txt should be generated"
  end

  def test_llms_full_txt_exists
    assert File.exist?(File.join(DEST_DIR, "llms-full.txt")), "llms-full.txt should be generated"
  end

  def test_robots_txt_exists
    assert File.exist?(File.join(DEST_DIR, "robots.txt")), "robots.txt should be generated"
  end

  def test_domain_profile_exists
    assert File.exist?(File.join(DEST_DIR, ".well-known", "domain-profile.json")),
