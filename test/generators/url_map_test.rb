...
class UrlMapTest < Minitest::Test
  ...
  def test_output_relative_to_project_root_when_config_exists
    ...
    assert File.exist?(expected_path), "url map should be written relative to project root"
  end
  ...
  def test_output_falls_back_to_source_without_config
    ...
    assert File.exist?(output_path), "url map should fall back to site.source"
  end
